...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="card mb-3">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-3">
                        <span class="w-100">Applicants : {{$job->totalJobApplications}}</span>
                    </div>
                    <div class="col-3">
                        <span class="w-100">
                            <a href="{{route('jobdetails',['id' => $job->id])}}" class="btn btn-primary">View</a>
        ...
        @endforeach
        <p>Showing {{ $jobdetails->firstItem() }} to {{ $jobdetails->lastItem() }} of {{ $jobdetails->total() }} results</p>
    <div class="d-flex justify-content-end">
        ...
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a href="{{ $jobdetails->previousPageUrl() }}" class="page-link" rel="prev">Previous</a>
                </li>
            @endif

            @if ($jobdetails->hasMorePages())
                <li class="page-item">
                    <a href="{{ $jobdetails->nextPageUrl() }}" class="page-link" rel="next">Next</a>
                </li>
            @else
                <li class="page-item disabled">
