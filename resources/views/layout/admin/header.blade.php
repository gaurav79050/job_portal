      ...
      <div class="sidebar-wrapper sidebar-theme">
         <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
               ...
               <li class="menu ">
                  <a href="{{url('admin/profile')}}"  class="dropdown-toggle">
                     <div class="">
               ...
               <li class="menu ">
                  <a href="{{url('admin/jobupload')}}"  class="dropdown-toggle">
                     <div class="">
                      
                        <span>Job Upload</span>
                     </div>

                  </a>
               </li>
               <li class="menu ">
                  <a href="{{url('admin/joblist')}}"  class="dropdown-toggle">
                     <div class="">
               ...
               <li class="menu ">
                  <a href="{{route('applications')}}"  class="dropdown-toggle">
                     <div class="">                       
